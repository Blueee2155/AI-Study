...
- The ONLY non-standard globals are: `tools`, `text`, `exit`, `ALL_TOOLS`.
...
- Use `ALL_TOOLS` to inspect available tool names, descriptions, and parameter schemas at runtime.
